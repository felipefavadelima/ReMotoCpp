//Code description: This code implements an K(Potassium) slow ionic channel using Destexhe aproximation.
...
#ifndef DESTEXHE_KS_CHANNEL_H
#define DESTEXHE_KS_CHANNEL_H
...
//Structs and classes
typedef struct DESTEXHE_KS_CHANNEL_CONSTRUCTOR_STRUCT
{
	//Channel specific maximum conductance mS/cm2
	num_type gKs_bar_mS_cm2;
	//Channel region area um2
	num_type region_area_um2;
	//Parameter alpha_q of Destexhe state equation (1/ms)
	num_type alpha_q_ms;
	//Parameter beta_q of Destexhe state equation (1/ms)
	num_type beta_q_ms;
...
}DESTEXHE_KS_CHANNEL_CONSTRUCTOR;

typedef struct NEW_DESTEXHE_KS_CHANNEL_STRUCT
{
	//Channel specific maximum conductance mS/cm2
	num_type gKs_bar_mS_cm2;
	//Parameter alpha_q of Destexhe state equation (1/ms)
	...
	//K ion nernst potencial in mV
	num_type k_ion_nernst_potencial_mV;
} NEW_DESTEXHE_KS_CHANNEL;

//Class of DESTEXHE_KS_CHANNEL
class DESTEXHE_KS_CHANNEL: public IONIC_CHANNELS
{
public:
	//Public Methods
	DESTEXHE_KS_CHANNEL(DESTEXHE_KS_CHANNEL_CONSTRUCTOR constructor);
...
private:
	...
	num_type gKs_bar_uS;
	//Parameter q0 of Destexhe state equation
	num_type q0;
	//Parameter alpha_q of Destexhe state equation (1/ms)
	num_type alpha_q_ms;
	//Parameter beta_q of Destexhe state equation (1/ms)
